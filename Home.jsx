...
import lilu from "../../assets/kepek/egyeb/lilu_profil.jpg";
import geos from "../../assets/kepek/egyeb/geos_profil.jpg";
// import "../../assets/kepek/egyeb/Comove_Vegleges_Szerzodes.pdf"
import {
  FaFacebookF,
  FaInstagram,
  FaSnapchatGhost,
            ...
            <div className="footerContainer">
              <div className="footerCol">
                ...
                <div className="footerSocials">
                  <a
                    href="[facebook.com](https://www.facebook.com/profile.php?id=61586242866516)"
                    target="_blank"
                    rel="noreferrer"
                    aria-label="Facebook"
                  >
                  ...
                  <a
                    href="[instagram.com](https://instagram.com)"
                    target="_blank"
                    rel="noreferrer"
                    aria-label="Instagram"
                  >
                  ...
                  <a
                    href="[tiktok.com](https://tiktok.com)"
                    target="_blank"
                    rel="noreferrer"
                    aria-label="TikTok"
                  >
              ...
              <div className="footerCol">
                ...
                <p>Az alább található részben tölthető le a bérleti szerződés</p>
                <a
                  href="../../../public/CoMove_Jognyilatkozat.pdf" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  download="CoMove_Jognyilatkozat.pdf"
                >
